...
<head>
    <meta charset="UTF-8">
    <title>Women's Watches | Watch Hunt</title>
                ...
                <nav>
                    <div class="wrapper">
                        ...
                        <ul class="search-icon">
                            ...
                            <i onclick="search()" class="fa fa-search" aria-hidden="true"></i>
                        </ul>
                    </div>
...
<!---------- featured products-------->
    <div class="small-container">
        ...
        <div class="row row-2">
            ...
            <select id="fid" onchange="wFilterQuery();">
            ...
            <select id="oid" onchange="wSortQuery();">
